...
**AI 생성 / 수정** — 프롬프트로 새로 그리거나, **현재 캔버스를 모델에게 보내
고치게** 합니다. "모자를 씌워줘", "몸을 빨갛게" 같은 요청이 가능합니다.
수정 모드는 요청과 무관한 부분을 유지하도록 지시하고 temperature도 낮춥니다 —
실측에서 실루엣이 100% 유지된 채 파랑 4색이 빨강 4색으로 바뀌었습니다.
